...
// Cooldown в минутах после завершения цикла
// Это НЕ "время сна" — это минимальная пауза перед следующим стартом
// Цикл завершился → cooldown → сразу новый
const INTERVALS = {
  CRITICAL:   1,   // горит — почти сразу
  ACTIVE:     1,   // активная задача — через минуту
  LEARNING:   2,   // изучение — чуть дольше осмыслить
  NORMAL:     2,   // обычный
  IDLE:       3,   // даже IDLE = 3 мин, не больше
};
